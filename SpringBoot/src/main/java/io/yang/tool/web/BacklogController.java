package io.yang.tool.web;

import io.yang.tool.domain.Project;
import io.yang.tool.domain.ProjectTask;
import io.yang.tool.services.MapValidationErrorService;
import io.yang.tool.services.ProjectTaskService;
...
public class BacklogController {
    ...
    // get all tasks in a giving project
    ...
    public ResponseEntity<?> updateProjectTask(@Valid @RequestBody ProjectTask projectTask, BindingResult result,
                                               @PathVariable String backlog_id, @PathVariable String project_task_id) {
        ResponseEntity<?> errorMap = mapValidationErrorService.MapValidationService(result);
        if (errorMap != null) return errorMap;
